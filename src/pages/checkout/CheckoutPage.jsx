...
export default function CheckoutPage() {
    ...
    const handleSaveClick = (id) => {
        if (newQuantity > 100) {
            ...
            setModalMessage("You can only order up to 100 items per product. If you wish to place a bulk order, please contact us through the Contact section.");
            setModalOpen(true);
            return;
        }
    ...
    return (
        <div className="checkout-page">
            ...
            <div className="checkout-container">
                ...
                />
                <CheckoutDetails calculateTotal={calculateTotal} handleSubmit={handleSubmit} />
            </div>
            <TransitionsModal
                open={modalOpen}
